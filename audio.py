# app.py → 1000% WORKING FINAL VERSION (Text + PDF → German MP3 + Text)
...
def process_lines(lines, english_first, slow_german):
    ...
    for i, eng_line in enumerate(lines):
        ...
        if key in st.session_state.cache:
            ...
            try:
                ger_text = st.session_state.translator.translate(eng_line, src='en', dest='de').text
...
st.caption("Text paste karo ya PDF daalo → German MP3 + Text ban jaayega • 1000% working • Dec 2025")